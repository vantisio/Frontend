  ...
  return (
    <>
      <DocumentationLayout navigation={navigation}>
        <DocHero
          title="مستندات سرمایه‌گذاری Vantis Social"
        ...
        <DocSection id="introduction" title="معرفی">
          <p className="font-persian text-text-secondary leading-relaxed">
            این مستندات اطلاعات جامع و محرمانه در مورد Vantis Social، فرصت‌های سرمایه‌گذاری، و چشم‌انداز آینده شرکت را ارائه می‌دهد.
          </p>
        </DocSection>
